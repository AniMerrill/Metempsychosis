...
onready var north_wall_no_door = preload("res://graphics/room/base/back_wall_no_door.png")
onready var north_wall_door = preload("res://graphics/room/base/back_wall_door.png")
...
func set_final_door_east():
	$EastDoor.texture = load("res://graphics/room/base/blue_side_door.png")

func set_final_door_west():
	$WestDoor.texture = load("res://graphics/room/base/red_side_door.png")
